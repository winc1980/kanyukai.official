...
export default function SlideComponent({ imgProps }: Props) {
    ...
    return (
        <div class="slide_wrapper">
            <div>
                <div class="flex absolute top-3 left-3 z-50">
            ...
            >
                {imgProps.map((img, index) => (
                    <div >
                        <img src={img.src} width={img.width} height={img.height} alt="img" />
                    </div>
                ))}
            </div>
